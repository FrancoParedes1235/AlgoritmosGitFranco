...
public class App {
    public static void main(String[] args) {
        ...
        ContainerRect contenedor = new ContainerRect(numMaxRectangulos); // Crear un contenedor
            ...
            switch (opcion) {
                case 1:
                    if (contenedor.getNumRec() < numMaxRectangulos) {
                        for (int i = 0; i < numMaxRectangulos; i++) {
                            ...
                            String[] tokens1 = input1.split(" "); // Dividir la cadena en tokens usando el espacio como
                                                                  // delimitador
                ...
                case 2:
                    if (contenedor.getNumRec() >= 2) {
                        System.out.println("Ingrese el número del primer rectángulo a comparar:");
                        int indiceRectangulo1 = scanner.nextInt();
                        System.out.println("Ingrese el número del segundo rectángulo a comparar:");
                        int indiceRectangulo2 = scanner.nextInt();

                        // Verificar que los índices estén dentro del rango
                        if (indiceRectangulo1 >= 1 && indiceRectangulo1 <= contenedor.getNumRec() &&
                                indiceRectangulo2 >= 1 && indiceRectangulo2 <= contenedor.getNumRec()) {
                            // Obtener los rectángulos a comparar
                            Rectangulo rectangulo1 = contenedor.getRectangulos()[indiceRectangulo1 - 1];
                            Rectangulo rectangulo2 = contenedor.getRectangulos()[indiceRectangulo2 - 1];

                            // Realizar la comparación
                            System.out.println("Comparación entre el rectángulo " + indiceRectangulo1
                            ...
                            System.out.println(
                                    "¿Los rectángulos están juntos? " + Verificador.esJunto(rectangulo1, rectangulo2));
                            System.out.println("¿Los rectángulos están disjuntos? "
                                    + Verificador.esDisjunto(rectangulo1, rectangulo2));
                        } else {
                            System.out.println("Los números de rectángulo ingresados no son válidos.");
                        }
                    } else {
                        System.out.println("No hay suficientes rectángulos almacenados para comparar.");
                    }
                    break;
